...
public class CreateTableService {
	...
	public void salvar(CreateTableForm createTableForm) {
		...
		try (OutputStream os = new FileOutputStream("src/main/resources/db/changelog/tables/" + Versao.ATUAL + "_" + LocalDate.now()  + "_create_table_" + createTableForm.getCreateTableChange().getTableName())) {
